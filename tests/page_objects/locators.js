module.exports = {
    ...
    skipAdButton: '.videoAdUiSkipButton videoAdUiAction videoAdUiRedesignedSkipButton', // Selector for the ad skip button bodybody //body
    adSelector: '.videoAdUi', // Selector for the ad video player
    // adSelector: ".enigma-watermark",
    ...
    mostPopular: '.trending-articles__list' // Selector for Most Popular section
  };
